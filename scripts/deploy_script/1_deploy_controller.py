...
def main():
    ...
    controller = deployer.deploy(Controller)
    ...
    usdc_market.setController(controller, {"from": deployer})
    metis_market.setController(controller, {"from": deployer})

    print(f"Controller deployed at {controller}")
